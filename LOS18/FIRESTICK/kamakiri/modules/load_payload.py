...
def load_pl_payload(dev):
    ...
    #payload = load_payload_file("../bin/preloader.bin")
    #payload = load_payload_file("../bin/preloader.patched.bin")
    #dev.send_da(0x201000, len(payload), 0, payload)
    #dev.jump_da(0x201000)
